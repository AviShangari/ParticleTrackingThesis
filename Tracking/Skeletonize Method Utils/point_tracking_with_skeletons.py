...
track_memory = []
next_id = 0
keypoint_tracks = {}  # worm_id: list of 15 point histories
...
#  Video generation 
output_video_path = os.path.join("./Tracking/Output/Skeletal_Tracking", "skeleton_tracked_video10-2.mp4")
